...
type OfferIdempotencyRepository struct {
	db *sql.DB
}

func NewOfferIdempotencyRepository(db *sql.DB) *OfferIdempotencyRepository {
	return &OfferIdempotencyRepository{
		db: db,
	}
}

func (r *OfferIdempotencyRepository) ClaimOrGet(ctx context.Context, idempotency domain.OfferIdempotencyKey) (domain.OfferIdempotencyKey, bool, error) {
...
func (r *OfferIdempotencyRepository) getByKeyForUpdate(ctx context.Context, tx *sql.Tx, idempotencyKey string) (domain.OfferIdempotencyKey, error) {
	query := `
		SELECT
			idempotency_key,
			request_hash,
...
func (r *OfferIdempotencyRepository) insertClaim(
	ctx context.Context,
	tx *sql.Tx,
...
func (r *OfferIdempotencyRepository) takeOverClaim(
	ctx context.Context,
	tx *sql.Tx,
	idempotency domain.OfferIdempotencyKey,
) (string, error) {
...
func (r *OfferIdempotencyRepository) GetByKey(
	ctx context.Context,
	key string,
...
func (r *OfferIdempotencyRepository) GetByOfferId(
	ctx context.Context,
	offerId string,
) (domain.OfferIdempotencyKey, error) {
	query := `
...
func (r *OfferIdempotencyRepository) MarkCompleted(
	tx *sql.Tx,
	ctx context.Context,
...
func (r *OfferIdempotencyRepository) MarkFailed(
	tx *sql.Tx,
	ctx context.Context,
	idempotencyKey string,
	errorCode string,
